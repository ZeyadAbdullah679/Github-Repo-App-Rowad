...
import com.example.githubreposapp.presentation.screens.error_connection_screen.NetworkErrorScreen
...
sealed class Screens(val route: String) {
    ...
    data object NetworkErrorScreen : Screens("network_error_screen")
}
...
fun AppNavHost() {
    ...
    NavHost(
        ...
        composable(
            route = Screens.NetworkErrorScreen.route,
        ) {
            NetworkErrorScreen(
                onClickRetry = { }
            )
